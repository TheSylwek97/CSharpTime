...
namespace UnitTestProjectStructsTimePeriod
{
    ...
    {/*
        [DataTestMethod]
        [DataRow(5, 0, 0, 10, 0, 0,2)]
        public void Multi(Int32 timeHoursP, Int32 timeMinutesP, Int32 timeSecondsP,
                          Int32 resultHours, Int32 resultMinutes, Int32 resultSeconds,
                          Int32 multi)
        {
            TimePeriod timePeriod = new TimePeriod(Convert.ToByte(timeHoursP), Convert.ToByte(timeMinutesP), Convert.ToByte(timeSecondsP));

            TimePeriod result = TimePeriod.Multiplication(timePeriod, multi);
            Assert.AreEqual(result, new Time(Convert.ToByte(resultHours), Convert.ToByte(resultMinutes), Convert.ToByte(resultSeconds)));
        }*/
